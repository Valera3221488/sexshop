...
<div id="content">
 ...
 <div class="container-fluid">
  ...
  <div class="alert alert-danger">
   <i class="fa fa-exclamation-circle"></i> <?php echo $warning; ?> <a class="close" data-dismiss="alert">&times;</a>
  </div>
  <?php } ?>
...
function getFilterFieldText(this_) {
	...
	if (field) {
		...
		html += '<img src="language/<?php echo $language["code"]; ?>/<?php echo $language["code"]; ?>.png" alt="<?php echo $language["name"]; ?>" title="<?php echo $language["name"]; ?>" />&nbsp;';
		<?php } ?>
	}
