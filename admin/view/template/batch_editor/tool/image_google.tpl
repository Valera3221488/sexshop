...
<table class="be-list">
 <tfoot>
  <tr>
   <td class="left" colspan="2"><form id="form-image_google-data<?php echo $product_id; ?>">
  ...
  <tr>
   <td class="left" colspan="2"><form id="form-image_google<?php echo $product_id; ?>">
     <p>
      <?php echo $text_folder; ?>: <a class="btn btn-danger btn-xs" onclick="resetFolderImageGoogle('<?php echo $product_id; ?>');" title="<?php echo $text_reset; ?>"><i class="fa fa-repeat"></i></a>
