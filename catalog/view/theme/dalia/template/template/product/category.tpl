  			...
  			<div class="name-actions col-sm-4">
  				...
  				<ul>
  				     <?php if($theme_options->get( 'display_add_to_cart' ) != '0') { ?>
  				          ...
  				          <?php } else { ?>
  				          <li class="addtocart"><a onclick="cart.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" data-original-title="<?php echo $button_cart; ?>"><i class="fa fa-shopping-bag"></i>Add To Cart</a></li>
  				          <?php } ?>
  				     <?php } ?>
  					...
  					<li><a onclick="wishlist.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" data-original-title="<?php if($theme_options->get( 'add_to_wishlist_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'add_to_wishlist_text', $config->get( 'config_language_id' ) ); } else { echo 'Add to wishlist'; } ?>"><i class="fa fa-gift"></i></a></li>
  					<?php } ?>
  				</ul>
  			</div>
