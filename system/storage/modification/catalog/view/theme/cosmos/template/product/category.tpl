  			...
  			<div class="name-actions col-sm-4">
  				...
  				<ul>
  					...
  					<?php } ?>
                    				          ...
                    				          <li class="add-cart"><a onclick="cart.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" data-original-title="<?php echo $button_cart; ?>"><span>Add to Cart</span></a></li>
  				          <?php } ?>
  				     <?php } ?>
